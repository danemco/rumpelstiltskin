...
urlpatterns = patterns('',
    url(r'^$', views.ListRecords.as_view(), name="list-index"), # Index page to show a list of latest entries
    url(r'^record/(?P<pk>\d+)/$', views.RecordDetail.as_view(), name="record-detail"), # Detail of a time card entry
    url(r'^record/(?P<pk>\d+)/edit/$', views.RecordUpdate.as_view(), name="record-edit"), # Detail of a time card entry
    url(r'^record/(?P<pk>\d+)/delete/$', views.RecordDelete.as_view(), name="record-delete"), # Detail of a time card entry
    url(r'^record/add/$', views.RecordAdd.as_view(), name="record-add"), # Detail of a time card entry
